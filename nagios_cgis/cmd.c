...
/* Altinity patch: This is a log which opsviewd will read from and insert records into auditlog database.
   This will silently fail for slave which is run in context of nagcmd group and does not have write permission - this is okay */
